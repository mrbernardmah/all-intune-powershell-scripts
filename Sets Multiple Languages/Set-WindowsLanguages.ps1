...
$Languages.AddRange(@(
    "en-US", "ar-SA", "zh-HK", "zh-CN", "zh-TW", "el-GR", "he-IL", 
    "ja-JP", "ko-KR", "zh-Hant-TW", "jp-JP", "am-ET", "Cy-az-AZ", 
    "Lt-az-AZ", "fa-IR", "ka-GE", "en-AU", "bn-BD", "bg-BG", 
    "my-MM", "hr-HR", "cs-CZ", "da-DK", "nl-NL", "fi-FI", "fr-FR", 
    "de-DE", "gu-IN", "hi-IN", "hu-HU", "id-ID", "it-IT", "mk-MK", 
    "mt-MT", "ne-NP", "pl-PL", "pt-PT", "pa-IN", "ro-RO", "ru-RU", 
    "sr-Latn-RS", "si-LK", "sk-SK", "es-ES", "sv-SE", "tl-PH", 
